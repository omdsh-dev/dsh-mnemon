...
[观看当前演示](../../assets/showcase/demo.mp4)。下方截图来自真实本地 DSH WebUI、dsh-mnemon 0.5.2 和合成的 Atlas 数据。录制展示浏览与可逆的增强开关，不代表模型质量或云端 Provider 实测。[录制环境与边界](../../assets/showcase/README.md)。
...
![当前状态与 Native 就绪情况](../../assets/showcase/zh-CN/status.png)
...
![默认记忆层与三个可选增强](../../assets/showcase/zh-CN/enhancements.png)
...
![工作记忆筛选与 Runtime 条目](../../assets/showcase/zh-CN/runtime.png)
...
![Atlas 档案目录与 Markdown 阅读器](../../assets/showcase/zh-CN/documents.png)
...
![两个已激活的本地记忆体](../../assets/showcase/zh-CN/spaces.png)
...
![保留来源的 Native 证据](../../assets/showcase/zh-CN/content.png)
