...
兼容性测试以真实会话运行新旧 DSH registry，覆盖空快照、活跃与脱离会话回放、重复用量样本、检查点恢复、跨代检查点、变更通知和过期状态重算。可复现命令见[开发指南](https://github.com/omdsh-dev/dsh-mnemon/blob/v0.4.4/docs/zh-CN/development.md)。
