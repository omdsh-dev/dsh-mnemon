...
export function resolvePersistenceStrategy(value: MemoryPersistenceStrategy | undefined): ResolvedConfig['persistenceStrategy'] {
...
export function resolveEmbedding(value: Config['embedding']): ResolvedConfig['embedding'] {
...
export function resolveRecallQuality(value: RecallQualityConfig | undefined): ResolvedConfig['recallQuality'] {
