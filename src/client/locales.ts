...
export const zh = {
  ...
  'config.displayBuildinHint': '会话内标签页，自动跟随当前会话的记忆范围',
  ...
  'config.runtimeUserScopeDescription': 'USER.md 可以跟随当前记忆范围，也可以单独保持全局；MEMORY.md、项目档案与记忆体仍使用上方范围。',
...
export const en = {
  ...
  'config.displayBuildin': 'Buildin',
  'config.displayBuildinHint': 'Conversation tab that automatically follows the session memory scope',
