...
export const zh = {
  ...
  'status.reviewTeamPaused': 'Agent Teams 工具在役时暂停空闲审查：已发布的子代理策略与 fork 和 spawn 均不兼容。不更改召回与主动写入设置。',
  ...
  'config.tab': 'Mnemon',
  'config.title': '记忆系统设置',
  'config.openPanel': '打开记忆设置',
  'config.openPanelHint': '在完整面板中调整记忆与上下文设置。',
  'config.backToSettings': '返回设置',
  'config.description': '管理记忆范围、上下文策略与存储服务。',
  ...
  'config.runtimeUserScopeDescription': '用户偏好可跟随记忆范围，也可单独跨工作区共享。',
...
export const en = {
  ...
  'status.reviewTeamPaused': 'Idle review is paused while Agent Teams tools are active: the published child policy is incompatible with both fork and spawn. Recall and writeback settings are unchanged.',
  ...
  'config.openPanel': 'Open memory settings',
  'config.openPanelHint': 'Use the full panel to adjust memory and context settings.',
  'config.backToSettings': 'Back to settings',
  'config.description': 'Manage memory scope, context strategies, and storage services.',
  ...
  'config.displayDescription': 'Choose where to open the memory workspace.',
  ...
  'config.storageDescription': 'Share across workspaces or keep them separate. Only workspace-aware storage services follow this setting.',
  ...
  'config.runtimeUserScopeDescription': 'Keep user preferences with memory, or share them across workspaces.',
