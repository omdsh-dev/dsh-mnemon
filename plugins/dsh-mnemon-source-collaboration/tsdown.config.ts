...
export default defineConfig([
 ...
 { entry: { client: 'src/client.tsx' }, outDir: 'lib', format: 'cjs', platform: 'browser', target: 'es2022', dts: false, clean: false, fixedExtension: false,
   ...
   outputOptions: { banner: 'window.__ModuleLoader__.load({ id: "dsh-mnemon-source-collaboration", factory: (require) => {', intro: 'var module = { exports: {} }; var exports = module.exports;', footer: 'return module.exports; } });' },
 },
])
