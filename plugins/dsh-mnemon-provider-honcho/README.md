...
An adapter for Honcho workspace conclusions and peer-scoped durable memory.

Requires a configured Honcho service, workspace and peer identities. It does not synthesize graph capabilities.
