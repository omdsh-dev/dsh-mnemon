...
export const definition = defineMemorySpaceProviderDefinition({
  manifest: {
    ...
    typeId: descriptor.id, packageName: 'dsh-mnemon-provider-openviking', version: '0.5.0-beta.1',
  ...
  create: context => new OpenVikingProvider(context.memoryBodies, { requestTimeoutMs: context.config.timeoutMs, settlementTimeoutMs: context.config.timeoutMs }),
})
