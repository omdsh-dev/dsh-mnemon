...
import { HindsightProvider } from './driver.ts'
import { descriptor } from './descriptor.ts'

export { HindsightProvider, descriptor }

export const definition = defineMemorySpaceProviderDefinition({
  manifest: {
    apiVersion: MEMORY_SPACE_PROVIDER_API_VERSION, kind: 'provider',
    typeId: descriptor.id, packageName: 'dsh-mnemon-provider-hindsight', version: '0.5.0-beta.1',
