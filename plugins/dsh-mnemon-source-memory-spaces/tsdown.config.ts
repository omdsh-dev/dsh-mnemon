...
{
  entry: ['src/contracts.ts', 'src/index.ts', 'src/provider-sdk.ts', 'src/testing.ts'], outDir: 'lib', format: 'esm', platform: 'node',
...
const id = ${JSON.stringify('dsh-mnemon-source-memory-spaces/presentation/' + file)};
